   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
               ...
               Thanlyin Technological University.</a>
            </div>
            <!-- /.navbar-header -->
...
?> 
                    ...
                    <?php } ?>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <?php if ($_SESSION['ACCOUNT_TYPE']=='Administrator') { ?>
                                <li>
                                    <a href="#"><i class="fa  fa-file-text fa-fw"></i> Register  <span class="fa arrow"></span></a>
                                     <ul  class="nav nav-third-level">
                                        <li><a href="<?php echo web_root; ?>admin/student/index.php?view=registrationform"> Registration Form</a></li>
                                        <li><a href="<?php echo web_root; ?>admin/importexcel/index.php?view=import" > Import Excel</a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                                <li>
                                    <a href="#"><i class="fa  fa-file-text fa-fw"></i> List  <span class="fa arrow"></span></a>
                                     <ul  class="nav nav-third-level">
                                        <li><a href="<?php echo web_root; ?>admin/student/index.php">All Student</a></li>
                                        <li><a href="<?php echo web_root; ?>admin/student/index.php?view=yearlist">By Year</a></li>
                                    </ul>
                                </li>
                            </ul>
                            <!-- /.nav-third-level -->
                                ...
                                <li>
                                    <a href="#">Class List  <span class="fa arrow"></span></a>
                                     <ul  class="nav nav-third-level">
                                        ...
                                        <li style="display: none;"><a href="<?php echo web_root; ?>admin/report/index.php?view=perSubject" >Students Enrolled per Subject</a></li>
                                        <li style="display: none;"><a href="<?php echo web_root; ?>admin/report/index.php?view=perSection" >Students enrolled per Section</a></li>
  ...
  <div id="page-wrapper">
    ...
    <!-- /#wrapper -->
      ...
      <!-- <footer><p align="Left">&copy; THANLYIN TECHNOLOGICAL UNIVERSITY </p></footer> -->
