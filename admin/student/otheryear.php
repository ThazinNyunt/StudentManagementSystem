...
<form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
  ...
  <div class="col-md-14"><h2>Add New Student (Second to Final Year Form)</h2><br></div>
    <table class="table"> 
    <tr style="display: none;" >
      ...
      <td><label>Course/Year</label></td>
        <td colspan="5">
          ...
          <select class="form-control input-sm" name="COURSE" required>
                ...
                $mydb->setQuery("SELECT * FROM `course` WHERE COURSE_LEVEL > 1 ORDER BY DEPT_ID ASC");
                ...
                foreach ($cur as $result) {
                  ...
                  echo '<option value='.$result->COURSE_ID.' >'.$result->COURSE_NAME.' - '.$Level.' </option>';
      ...
      <tr>
        ...
        <td colspan="5">
          <input id="PSLIP" name="PSLIP" type="file">
        </td>
      </tr>
