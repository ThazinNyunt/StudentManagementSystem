...
"Account Id" type="Hidden" value="<?php echo $_GET['gid']; ?>">
      ...
      <div class="form-group">
        <div class="col-md-12">
          <label class="col-md-4 control-label" for=
          "FIRSTGRADING">Exam Marks:</label>

          <div class="col-md-6">
            
             <input class="form-control input-sm" id="FIRSTGRADING" name="FIRSTGRADING" placeholder=
                "First Grading" type="number" value="<?php echo $resgrades->FIRST; ?>" autocomplete="off"  required>
          </div>
        </div>
      </div>
      ...
      <!-- <div class="form-group">
        <div class="col-md-12">
          <label class="col-md-4 control-label" for=
          "SECONDGRADING">Final Exam Marks:</label>

          <div class="col-md-6">
            
             <input class="form-control input-sm" id="SECONDGRADING" name="SECONDGRADING" placeholder=
                "Second Grading" type="number" value="<?php echo $resgrades->SECOND; ?>" autocomplete="off" required>
          </div>
        </div>
      </div> -->
<!-- 
...
<script type="text/javascript">
   ...
   var tot;
    ...
    first = parseFloat(first) * 1.0;
    // second = parseFloat(second) * .50;
    // third = parseFloat(third) * .20;
    // fourth = parseFloat(fourth) * .40

    tot = parseFloat(first);
   ...
   //  first = parseFloat(first) * .50;
   //  second = parseFloat(second) * .50;
   //  // third = parseFloat(third) * .20;
   //  // fourth = parseFloat(fourth) * .40

   //  tot = parseFloat(first) +  parseFloat(second);
