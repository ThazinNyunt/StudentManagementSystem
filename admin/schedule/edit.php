            ...
            <!--        <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <select class="form-control input-sm" name="sched_day" id="sched_day"> 
                            <option value="Monday"  <?php echo ($res->sched_day=='Monday') ? 'selected="true"': '' ; ?>>Monday</option>
                            <option value="Tuesday" <?php echo ($res->sched_day=='Tuesday') ? 'selected="true"': '' ; ?> >Tuesday</option> 
                            <option value="Wednesday"  <?php echo ($res->sched_day=='Wednesday') ? 'selected="true"': '' ; ?>>Wednesday</option>
                            <option value="Thursday"  <?php echo ($res->sched_day=='Thursday') ? 'selected="true"': '' ; ?>>Thursday</option>
                            <option value="Friday"  <?php echo ($res->sched_day=='Friday') ? 'selected="true"': '' ; ?>>Friday</option>
                        </select>
                      </div>
                    </div>
                  </div>
