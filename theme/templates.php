...
<title><?php echo $title; ?> | THANLYIN TECHNOLOGICAL UNIVERSITY</title>
...
<body style="Pbackground-color:#0b5394" >

<div class="navbar-fixed-top navbar-TOPsm  col-md-10    col-md-offset-1"    role="navigation">
  <div class="container">
    <div class="navbar-header">
          <h5 class="navbar-menu p" >THANLYIN TECHNOLOGICAL UNIVERSITY</h5>
        ...
        <ul class="navbar-nav p navbar-left tooltip-demo" style="margin-left:-8%;"> 
            <li class="dropdown dropdown-toggle ">
              <a  data-toggle="tooltip" data-placement="left" title="Contact Us"   href="<?php echo web_root.'index.php?q=contact';  ?>"> 
               <i class="fa fa-phone fa-fw"> </i>  Call Us: +959264833390 OR Contact Us: contact@tuthanlyin.edu.mm
              </a>
            </li>
            <li><span>    ||    </span></li>
            <li>
   ...
   <div class="col-md-4">
    <div class="row "> 
     <p > 
        ...
        <h1 align="center" >THANLYIN TECHNOLOGICAL UNIVERSITY</h1>
        </a>
    </p>
 ...
 <div class="navbar navbar-static-top navbar-magbanua col-md-10    col-md-offset-1 "    role="navigation">
      ...
      <div class="container ">
       ...
       <!--  <a class="navbar-brand"  href="<?php echo web_root; ?>index.php" title="View Sites">THANLYIN TECHNOLOGICAL UNIVERSITY</a> -->
        </div>
<?php
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="panel panel-default">
                  <div class="panel-heading" style="background-color:#0b5394;color:#fff;">
                  <b><?php   
...
?>
            ...
            <footer class="panel-footer" style="background-color:#0b5394;color:#fff;" >
              <p align="left" >&copy; THANLYIN TECHNOLOGICAL UNIVERSITY</p>
           </footer>
      </div>
